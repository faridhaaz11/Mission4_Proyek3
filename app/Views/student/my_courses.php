...
<body>
                    ...
                    <div class="col">
                        <div class="card h-100">
                            <div class="card-body">
                                ...
                                <div class="mt-3">
                                        <button class="btn btn-danger btn-sm btn-delete-enrolled" data-course-id="<?= esc($course['course_id']) ?>">Hapus</button>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <script>
        const enrolledCoursesData = <?= json_encode($enrolledCourses) ?>;
    </script>
